...
def draw_cloud(x, y):
    arcade.draw_ellipse_filled(x, y, 80, 40, arcade.csscolor.GAINSBORO)
    arcade.draw_circle_filled(x - 40, y + 5, 15, arcade.csscolor.GAINSBORO)
    arcade.draw_circle_filled(x - 20, y + 15, 15, arcade.csscolor.GAINSBORO)
    arcade.draw_circle_filled(x, y + 19, 15, arcade.csscolor.GAINSBORO)
    arcade.draw_circle_filled(x + 20, y + 15, 15, arcade.csscolor.GAINSBORO)
    arcade.draw_circle_filled(x + 40, y + 5, 15, arcade.csscolor.GAINSBORO)
    arcade.draw_circle_filled(x + 25, y - 5, 15, arcade.csscolor.GAINSBORO)
    arcade.draw_circle_filled(x - 25, y - 5, 15, arcade.csscolor.GAINSBORO)
